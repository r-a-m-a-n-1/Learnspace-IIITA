  ...
  return (
    <div className="w-screen overflow-x-hidden">
      ...
      >
        ...
        {location.pathname === '/' && showArrow && (
          <div className="fixed bottom-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center z-20">
            <div style={{ ...arrowStyle, borderTopColor: 'black' }} />
            <div style={{ ...arrowStyle, borderTopColor: 'rgba(0, 0, 0, 0.7)', animationDelay: '0.3s' }} />
            <div style={{ ...arrowStyle, borderTopColor: 'rgba(0, 0, 0, 0.5)', animationDelay: '0.6s' }} />
          </div>
        )}
      </div>
