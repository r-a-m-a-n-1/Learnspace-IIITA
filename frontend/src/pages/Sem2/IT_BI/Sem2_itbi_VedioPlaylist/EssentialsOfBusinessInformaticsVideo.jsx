...
const EBI = () => {
  // REBIlace these video IDs with your actual YouTube video IDs (one for each of the 50 videos)
  const videoIDs = [
    "7GRiW8zHjWg",
    "CRYqlVKYH78",
    "pMsBRtRBrR0",
  ...
  const videoDescriptions = [
    ...
    "Information Systems in Organizations - Principles of Business Information Systems",
    "Hardware: Input, Processing, Output & Storage Devices - Principles of Business Information Systems",
    "Software: Systems & Application Software - Principles of Business Information Systems",
    "Organizing & Storing Data - Principles of Business Information Systems",
    "Computer Networks as a GAME CHANGER in Business Information Systems",
    "NAVIGATING the World of ERP: Operational Systems in Modern Business",
    "Management Information & Decision Support Systems - Principles of Business Information Systems",
    "Security Privacy & Ethical Issues in Information Systems -Principles of Business Information Systems",
    ...
    <div className="flex bg-black text-white w-full min-h-screen">
      ...
      <main className={`flex-1 pt-4 p-4 sm:p-8 ${sidebarOpen ? 'pr-64' : ''}`}>
        ...
        <div className="flex items-center justify-center mb-6 sm:mb-8 relative">
          <h1 className="text-3xl sm:text-4xl font-bold">Essentials of Buisness Informatics - Video Lectures</h1>
          <button
