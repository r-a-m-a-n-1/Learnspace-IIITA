...
// const Sem1_PreviousYearPaper = () => {
//   return (
//     <div className="fixed inset-0 bg-black text-white overflow-auto">
//       <div className="pt-24 pb-8 max-w-screen-xl mx-auto px-4 flex flex-col items-center">
//         <h1 className="text-4xl font-bold mb-8">Semester 1 - Previous Year Papers</h1>
//         <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
//           {/* Card 1 - Engineering Physics */}
//           <Link
//             to="/sem1/engineering-physics-paper"
...
//           <Link
//             to="/sem1/fundamental-electrical-paper"
...
//           <Link
//             to="/sem1/technical-communication-paper"
...
//           <Link
//             to="/sem1/professional-ethics-paper"
...
// export default Sem1_PreviousYearPaper;
    ...
    <div className="fixed inset-0 bg-black text-white overflow-auto">
      <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-screen-xl mx-auto flex flex-col items-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-10 text-center text-indigo-400 drop-shadow-md">
          📄 Semester 1 - Previous Year Papers
        </h1>
