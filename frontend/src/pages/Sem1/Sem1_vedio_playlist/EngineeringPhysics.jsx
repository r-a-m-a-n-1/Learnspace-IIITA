    ...
    <div className="bg-black text-white w-full min-h-screen">
      ...
      <div className="fixed top-0 left-0 w-full z-50 bg-gray-900 border-b border-gray-700">
        <div className="overflow-x-auto">
          <div className="min-w-max flex space-x-4 px-4 py-3 md:justify-center">
            {[
              ...
              <button
                ...
                className={`whitespace-nowrap px-3 py-1 rounded-full transition-all duration-500 ${
                  selectedSection === key
                    ? 'bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 bg-clip-text text-transparent'
                    : 'text-white'
                } hover:bg-gradient-to-r hover:from-purple-400 hover:via-pink-500 hover:to-red-500 hover:bg-clip-text hover:text-transparent`}
              >
                {label}
              </button>
            ))}
      ...
      {/* CONTENT */}
      <div className="pt-[calc(4rem+1rem)] md:pt-[calc(4rem+2rem)] p-4 sm:p-8">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 p-4 sm:p-6 rounded-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              ...
              <button
                onClick={closeVideo}
                className="text-white text-lg font-bold hover:text-red-500 transition"
              >
                ✖
              </button>
            </div>
