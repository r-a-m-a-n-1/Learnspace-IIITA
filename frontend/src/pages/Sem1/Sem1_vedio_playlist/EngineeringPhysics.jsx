...
//     id: i + 1,
//     title: `EP Video ${i + 1}`,
//     thumbnail: `https://res.cloudinary.com/demo/image/fetch/https://img.youtube.com/vi/${id}/hqdefault.jpg`,
//     videoUrl: `https://www.youtube.com/embed/${id}`,
//     description: epVideoDescriptions[i] || ""
//   }));
...
//   return (
//     <div className="bg-black text-white w-full min-h-screen">
//       {/* fixed navbar with hash-links */}
//       <div className="fixed top-0 left-0 w-full z-50 bg-gray-900 border-b border-gray-700 p-4 flex justify-center gap-4">
//         <a href="#classical" className="text-white px-3 py-1 rounded hover:bg-gray-700 transition">Classical</a>
//         <a href="#quantum" className="text-white px-3 py-1 rounded hover:bg-gray-700 transition">Quantum</a>
//         <a href="#semiconductor" className="text-white px-3 py-1 rounded hover:bg-gray-700 transition">Semiconductor</a>
//         <a href="#problems" className="text-white px-3 py-1 rounded hover:bg-gray-700 transition">Problems</a>
//       </div>
...
//         {/* Classical Section */}
//         <section id="classical" className="mb-12">
//           <h2 className="text-2xl font-bold mb-4 text-white">Classical Mechanics</h2>
//           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
//             {videoData.slice(0, 8).map((video) => (
//               <div
//                 key={video.id}
//                 onClick={() => openVideo(video)}
//                 className="bg-gray-800 rounded-lg shadow-lg cursor-pointer transform hover:scale-[1.02] transition duration-300 flex flex-row items-start p-3 sm:flex-col sm:p-4"
...
//           <h2 className="text-2xl font-bold mb-4 text-white">Quantum Mechanics</h2>
//           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
//             {videoData.slice(8, 16).map((video) => (
//               <div
//                 key={video.id}
//                 onClick={() => openVideo(video)}
//                 className="bg-gray-800 rounded-lg shadow-lg cursor-pointer transform hover:scale-[1.02] transition duration-300 flex flex-row items-start p-3 sm:flex-col sm:p-4"
...
//         <section id="semiconductor" className="mb-12">
//           <h2 className="text-2xl font-bold mb-4 text-white">Semiconductor Physics</h2>
//           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
//             {videoData.slice(16, 24).map((video) => (
//               <div
//                 key={video.id}
//                 onClick={() => openVideo(video)}
//                 className="bg-gray-800 rounded-lg shadow-lg cursor-pointer transform hover:scale-[1.02] transition duration-300 flex flex-row items-start p-3 sm:flex-col sm:p-4"
...
//         {/* Problems Section */}
//         <section id="problems">
//           <h2 className="text-2xl font-bold mb-4 text-white">Problem Solving</h2>
//           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
//             {videoData.slice(24, 32).map((video) => (
//               <div
//                 key={video.id}
//                 onClick={() => openVideo(video)}
//                 className="bg-gray-800 rounded-lg shadow-lg cursor-pointer transform hover:scale-[1.02] transition duration-300 flex flex-row items-start p-3 sm:flex-col sm:p-4"
...
//       {/* increased top padding on desktop so heading is never hidden */}
//       <div className="pt-20 md:pt-28 p-4 sm:p-8">
//         <h1 className="text-3xl sm:text-4xl font-bold text-center mb-6 sm:mb-8">
//           Engineering Physics - Video Lectures
//         </h1>
...
//         {/* Classical Section */}
//         <section id="classical" className="mb-12">
//           <h2 className="text-2xl font-bold mb-4">Classical Mechanics</h2>
//           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
//             {videoData.slice(0, 8).map((video) => (
//               <div
//                 key={video.id}
...
//         {/* Quantum Section */}
//         <section id="quantum" className="mb-12">
//           <h2 className="text-2xl font-bold mb-4">Quantum Mechanics</h2>
//           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
//             {videoData.slice(8, 16).map((video) => (
//               <div
//                 key={video.id}
...
//         {/* Semiconductor Section */}
//         <section id="semiconductor" className="mb-12">
//           <h2 className="text-2xl font-bold mb-4">Semiconductor Physics</h2>
//           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
//             {videoData.slice(16, 24).map((video) => (
//               <div
//                 key={video.id}
...
const EP = () => {
  ...
  return (
    <div className="bg-black text-white w-full min-h-screen">
      ...
      <div className="pt-24 md:pt-28 p-4 sm:p-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-center mb-6 sm:mb-8">
          Engineering Physics - Video Lectures
        </h1>
