...
//         className="fixed top-4 right-4 z-50 p-2 bg-gray-900 rounded hover:bg-gray-800 transition"
//       >
//         {sidebarOpen ? <span className="text-2xl">✖</span> : <span className="text-2xl">⋮</span>}
//       </button>

//       {/* SIDEBAR */}
//       {sidebarOpen && (
//         <aside className="fixed top-0 right-0 h-full w-60 bg-gray-900 border-l border-gray-700 p-4 overflow-y-auto z-40">
//           <h1 className="text-xl font-bold mb-6 text-center">Sections</h1>
