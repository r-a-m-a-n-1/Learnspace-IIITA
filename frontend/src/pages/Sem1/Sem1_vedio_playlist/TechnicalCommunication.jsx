...
const TCS = () => {
  // RTCSlace these video IDs with your actual YouTube video IDs (one for each of the 50 videos)
  const videoIDs = [
    "ZXqi3KqjyMA",
    "K2jGcTsj_Rs",
    "Qd9hnTFIFWw",
  ...
  const videoDescriptions = [
    "Technical Communication BTech 2nd Year KAS 301 401 AKTU PDF Notes, Videos & EBook Download",
    "Unit 1: Fundamentals of Technical Communication AKTU with PDF Notes | BTech 2nd Year KAS 301 401",
    "Unit 2: Forms of Technical Communication AKTU with PDF Notes | BTech 2nd Year KAS 301 401",
    "Unit 3: Technical Presentation: Strategies & Techniques with PDF Notes | BTech 2nd Year KAS 301 401",
    "Unit 4: Technical Communication Skills AKTU with PDF Notes | BTech 2nd Year KAS 301 401",
    "Unit 5: Dimensions of Oral Communication & Voice Dynamics AKTU with PDF Notes | BTech 2nd Year",
    ...
    <div className="flex bg-black text-white w-full min-h-screen">
      ...
      <main className={`flex-1 pt-4 p-4 sm:p-8 ${sidebarOpen ? 'pr-64' : ''}`}>
        ...
        <div className="flex items-center justify-center mb-6 sm:mb-8 relative">
          <h1 className="text-3xl sm:text-4xl font-bold">Technical Communication Skills - Video Lectures</h1>
          <button
