...
const YOGA = () => {
  // RYOGAlace these video IDs with your actual YouTube video IDs (one for each of the 50 videos)
  const videoIDs = [
    "UbyhT_ytlQU",
    "yLtV80mATGw",
    "2vCz1Urh7Rw",
  ...
  const videoDescriptions = [
    ...
    "84 yoga poses of hatha yoga| Basic asanas | only 7 minutes | Sanyoga | Yogi Sanjay",
    "पढ़ाई में अच्छा करने के लिए योग / Yoga for Focus and Awareness",
    "Daily Pranayama under 15-Minutes | Breathing Exercises & Yoga | Saurabh Bothra",
    "Daily Pranayama under 15-Minutes | Breathing Exercises & Yoga | Saurabh Bothra",
    "10-Minute Breathing Exercises for DEEP SLEEP | Pranayama Yoga | Saurabh Bothra Yoga",
    "Feel Peaceful in 10 Minutes | Meditation for Stress & Overthinking",
    "Surya Namaskar Yoga | Step by Step For Beginners | Sun Salutation 12 Steps | सूर्य नमस्कार | #yoga",
    ...
    <div className="flex bg-black text-white w-full min-h-screen">
      ...
      <main className={`flex-1 pt-4 p-4 sm:p-8 ${sidebarOpen ? 'pr-64' : ''}`}>
        ...
        <div className="flex items-center justify-center mb-6 sm:mb-8 relative">
          <h1 className="text-3xl sm:text-4xl font-bold">YOGA - Video Lectures</h1>
          <button
