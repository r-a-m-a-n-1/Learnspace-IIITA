...
const Sem4_ece_LectureNotes = () => {
  return (
    <div className="fixed inset-0 bg-black text-white overflow-auto">
      <div className="pt-24 pb-8 max-w-screen-xl mx-auto px-4 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-8">     📚 Semester 4 ECE - Lecture Notes</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">

          {/* Card 1 - Analog Communication */}
          <Link
            to="/sem4/ece/analog-communication-notes"
          ...
          <Link
            to="/sem4/ece/antenna-wave-propagation-notes"
          ...
          <Link
            to="/sem4/ece/cmos-vlsi-design-notes"
          ...
          <Link
            to="/sem4/ece/control-system-notes"
          ...
          <Link
            to="/sem4/ece/integrated-circuit-tech-notes"
          ...
          <Link
            to="/sem4/ece/money-and-banking-notes"
          ...
          <Link
            to="/sem4/ece/network-synthesis-filters-notes"
...
export default Sem4_ece_LectureNotes;
