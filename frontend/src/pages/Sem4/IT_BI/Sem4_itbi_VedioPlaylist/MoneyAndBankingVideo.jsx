...
const MB = () => {
  // RMBlace these video IDs with your actual YouTube video IDs (one for each of the 50 videos)
  const videoIDs = [
    "25lRR_Lwad8",
    "0qxqDkf7XoQ",
    "Esz6qrcaF8Y",
    ...
    <div className="flex bg-black text-white w-full min-h-screen">
      ...
      <main className={`flex-1 pt-4 p-4 sm:p-8 ${sidebarOpen ? 'pr-64' : ''}`}>
        ...
        <div className="flex items-center justify-center mb-6 sm:mb-8 relative">
          <h1 className="text-3xl sm:text-4xl font-bold">MB - Video Lectures</h1>
          <button
